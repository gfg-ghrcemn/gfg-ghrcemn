...
const AboutPage: React.FC = () => {
    React.useEffect(() => {
        window.scrollTo(0, 0); // Ensures the page scrolls to the top when the component loads
    }, []);
    ...
    return (
        <div className="p-8 px-20 relative top-10 bg-black text-green-500 flex flex-col items-center justify-center">
            <Fade direction="up" triggerOnce>
                ...
                <h2 className="text-3xl font-semibold mb-3 w-full text-start">
                    Activities
                </h2>
                ...
                <Link
                    ...
                    className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg shadow-green-600 shadow-lg"
                >
                    Join Us
                </Link>
            </Fade>
