      ...
      <div className="p-4">
        ...
        <div className="flex md:contents">
                ...
                <div className="relative p-4 my-6 text-green-500 sm:w-[60%] w-[90%] border-green-500 border-2  rounded-xl col-start-6 col-end-10 mr-auto">
                  <img src={event[4].image} alt="event" className="border-green-500 rounded-lg border-2 object-fit w-full h-40" />
                  <h3 className="text-lg font-semibold lg:text-xl">{event[4].title}</h3>
                  <p className="mt-2 leading-6">{event[4].description}</p>
                  <span className="absolute text-sm text-green-500 -top-5 left-2 whitespace-nowrap">{event[4].date}</span>
                  <Link to={event[4].link} target="_blank" className="h-[30%] py-5 text-sm w-full justify-start text-green-500 bottom-5 left-2 whitespace-nowrap underline">View More</Link>
                </div>
              </div>
              ...
              <div className="relative p-4 my-6 text-green-500 sm:w-[60%] w-[90%] border-green-500 border-2 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
                <img src={event[3].image} alt="event" className="border-green-500 rounded-lg border-2 object-fit w-full h-40" />
                <h3 className="text-lg font-semibold lg:text-xl">{event[3].title}</h3>
                <p className="mt-2 leading-6">{event[3].description}</p>
                <span className="absolute text-sm text-green-500 -top-5 left-2 whitespace-nowrap">{event[3].date}</span>
                <Link to={event[3].link} target="_blank" className="h-[30%] py-5 text-sm w-full justify-start text-green-500 bottom-5 left-2 whitespace-nowrap underline">View More</Link>
              </div>
                <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
                  <div className="flex items-center justify-center w-6 h-full">
          ...
          {/* Event 1 */}
              <div className="flex md:contents">
                ...
                <div className="relative p-4 my-6 text-green-500 sm:w-[60%] w-[90%] border-green-500 border-2  rounded-xl col-start-6 col-end-10 mr-auto">
                  <img src={event[2].image} alt="event" className="border-green-500 rounded-lg border-2 object-fit w-full h-40" />
                  <h3 className="text-lg font-semibold lg:text-xl">{event[2].title}</h3>
                  <p className="mt-2 leading-6">{event[2].description}</p>
                  <span className="absolute text-sm text-green-500 -top-5 left-2 whitespace-nowrap">{event[2].date}</span>
                  <Link to={event[2].link} target="_blank" className="h-[30%] py-5 text-sm w-full justify-start text-green-500 bottom-5 left-2 whitespace-nowrap underline">View More</Link>
                </div>
              </div>
              ...
              <div className="relative p-4 my-6 text-green-500 sm:w-[60%] w-[90%] border-green-500 border-2 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
                ...
                <Link to={event[1].link} target="_blank" className="h-[30%] py-5 text-sm w-full justify-start text-green-500 bottom-5 left-2 whitespace-nowrap underline">View More</Link>
              </div>
                <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
                  <div className="flex items-center justify-center w-6 h-full">
                    <div className="w-1 h-full bg-green-300 rounded-t-full bg-gradient-to-b from-green-400 to-green-300"></div>
